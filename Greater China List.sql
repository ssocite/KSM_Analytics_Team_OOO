...
where rpt_pbh634.v_entity_ksm_households.HOUSEHOLD_COUNTRY like '%China%'
or rpt_pbh634.v_entity_ksm_households.HOUSEHOLD_COUNTRY like '%Hong Kong%'
...
inner join V_KSM_25_REUNION r on r.id_number = e.id_number
